...
| Texture cover concept marker | Card media cover | `48px` |
...
Brand logos and wordmarks are not normal UI icons. Use `references/logo-system.md` and `assets/logos/` for Kimi logo, text logo, and sub-brand lockup assets.
...
- Do not use Kimi wordmarks or logo lockups as toolbar, button, inline, or texture concept icons.
