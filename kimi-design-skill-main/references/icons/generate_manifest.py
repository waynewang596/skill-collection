...
KEYWORD_CAT = {
    ...
    "brand": ["apple","android","kimiplus","kimiold","kimiclaw","alphalab","okcomputer",
...
FORCED = {
    ...
    "Robot":"brand","KimiPlus":"brand","KimiOld":"brand","Kimiclaw":"brand","Alphalab":"brand",
...
CN_MAP = {
    ...
    "Kimiclaw":["KimiClaw"],"KimiOld":["旧版Kimi"],"KimiPlus":["Kimi+"],
